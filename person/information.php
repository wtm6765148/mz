...
<html>
	...
	<head>
		...
		<script src="../AmazeUI-2.4.2/assets/js/amazeui.js"></script>	<style>
		 .am-form-group .am-form-label span{margin-left:130px}
		.am-form-group .am-email{margin-left:80px}
			...
			<div class="col-main">
				<div class="main-wrap">
							...
							<div class="filePic">
								...
								<?php 
									if(@$_SESSION['nickname']==null){
										echo "<img class='am-circle am-img-thumbnail' src='../images/getAvatar.do.jpg' alt='' />";
										
									}else{
										echo "<img class='am-circle am-img-thumbnail' src='../upfile/",$_SESSION['img'],"' alt='' />";
									}
					...
					<?php 
							...
							$sql="select * from xz_login where username='$uid'";
							...
							if(@$v['nickname']==null){
								...
								<label for='user-name2' class='am-form-label'style='margin-left:100px'>头像</label>
								<input name='imgfile' type='file' accept='image/gif, image/jpeg'/id='upfile'style='margin-left:200px'>
...
";
							...
							<form class='am-form am-form-horizontal'method='post' action='../conmon/loginData.php'>
								...
								<div class='am-form-group'>
									<label for='user-name2' class='am-form-label'>昵称:<span>",$v['nickname'],"</span></label>
									
								</div>

								<div class='am-form-group'>
									<label for='user-name' class='am-form-label'>姓名:<span>",$v['name'],"</span></label>
								</div>

								<div class='am-form-group'>
									<label class='am-form-label'>性别:<span>",$v['sex'],"</span></label>
								</div>

								<div class='am-form-group'>
									<label for='user-birth' class='am-form-label'>生日:<span>",$v['year'],'-',$v['month'],'-',$v['day'],"</span></label>
								</div>
								<div class='am-form-group'>
									<label for='user-phone' class='am-form-label'>电话:<span>",$v['phone'],"</span></label>
								</div>
								<div class='am-form-group'>
									<label for='user-email' class='am-form-label'>电子邮件:<span style='position:absolute;left:136px'>",$v['email'],"</span></label>
								</div>
								<div class='am-form-group address'>
									<label for='user-address' class='am-form-label'>收货地址</label>
									<div class='am-form-content address'>
								...
								<div class='info-btn'>
									<a href='../conmon/informationUpdata.php'style='color: #fff;
									 background-color: #dd514c;padding:5px;border-color:#ff6633;float:left;margin-left:100px'>修改</a>
								</div>
