...
<html xmlns="http://www.w3.org/1999/xhtml">
						...
						<li class="appliance js_toggle relative first">
							...
							<h3 class="category-name b-category-name"><i><img src="../images/cake.png"></i><a class="ml-22" title="点心">点心/蛋糕</a></h3>
								...
								<dt><span title="蛋糕">蛋糕</span></dt>
									 ...
									 $sql="select product,id from xz_product where family_id='1'";
									 $result=mysqli_query($conn,$sql);
									 $row=mysqli_fetch_all($result,1);
									 
										foreach($row as $v){

									echo "<dd><a title='",$v['product'],"' href='search.php?id={$v['id']}&page=1&all=综合'><span>",$v['product'],"</span></a></dd>";
								...
								<dt><span title="蛋糕">点心</span></dt>
								    <?php
									 ...
									 $sql="select product,id from xz_product where family_id='2'";
									 $result=mysqli_query($conn,$sql);
									 $row=mysqli_fetch_all($result,1);
									 
										foreach($row as $v){

									echo "<dd><a title='",$v['product'],"' href='search.php?id={$v['id']}'><span>",$v['product'],"</span></a></dd>";
			...
			<div class="shopMainbg">
				<div class="shopMain" id="shopmain">
					...
					<div class="am-g am-g-fixed recommendation">
						...
						<?php 
						require('../conmon/init.php');
						$sql="select lid,img,title,futitle from xz_laptop where shuxing='1' limit 0,3";
						$result=mysqli_query($conn,$sql);
						$row=mysqli_fetch_all($result,1);
						foreach($row as $v){

						echo "<div class='am-u-sm-4 am-u-lg-3 '>
							<div class='info'>
								<h3>",$v['title'],"</h3>
								<h4>",$v['futitle'],"</h4>
							</div>
							<div class='recommendationMain '>
								<a href='introduction.php?lid={$v['lid']}'>",$v['img'],"</a>
							</div>
						</div>";
	...
	<?php
						...
						require('../conmon/init.php');
						$sql="select lid,title,img,price from xz_laptop where pinpai='甜品' and lname='果冻类' limit 0,4";
						$result=mysqli_query($conn,$sql);
						$row=mysqli_fetch_all($result,1);
						foreach($row as $k){
							echo "<div class='am-u-sm-3 am-u-md-6 text-three'>
							<div class='outer-con '>
								<div class='title '>
									",$k['title'],"
								</div>
							...
							<a href='introduction.php?lid={$k['lid']}'>",$k['img'],"</a>
						</div>";
                 ...
                 <div class="clear "></div>
					...
					<div class="am-g am-g-fixed flood method3 ">
						<ul class="am-thumbnails ">
							...
							<?php 
								require('../conmon/init.php');
								$sql="select lid,title,img,price from xz_laptop where pinpai='海鲜' limit 0,10";
								$result=mysqli_query($conn,$sql);
								$row=mysqli_fetch_all($result,1);
								...
								foreach($row as $key){
									echo "<li>
								<div class='list'>
									<a href='introduction.php?lid={$key['lid']}'>
										",$key['img'],"
										<div class='pro-title '>",$key['title'],"</div>
										<span class='e-price '>￥",$key['price'],"</span>
									</a>
								</div>
							</li>
							";
