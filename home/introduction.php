		...
		<?php include('../include/top.php');?>
			...
			<div class="nav-table">
				...
				<ol class="am-breadcrumb am-breadcrumb-slash">
					<li><a href="#">首页</a></li>
					<li><a href="#">分类</a></li>
					<li class="am-active"><?php echo $v[19]?></li>
				</ol>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								...
								<a href="<?php echo $k[3]?>"><img src="<?php echo $k[2]?>" alt="细节展示放大镜特效" rel="<?php echo $k[3]?>" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="<?php echo $k[4]?>" mid="<?php echo $k[2]?>" big="<?php echo $k[3]?>"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price"><?php echo $v[5]?></b>  </dd>                                 
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice"><?php echo $v[6]?></b></dd>									
								</li>
								<div class="clear"></div>
							</div>
							...
							<div class="shopPromotion gold">
								<div class="hot">
									...
									<div class="gold-list">
										<p>
										购物满2件打8折，满3件7折<i class="am-icon-sort-down"></i></span></p>
									</div>
								</div>
								<div class="clear"></div>
								<div class="coupon">
							...
							<div class="am-tabs-bd">
								...
								<div class="am-tab-panel am-fade am-in am-active">
									<div class="J_Brand">
										...
										<div class="clear"></div>
										<ul id="J_AttrUL">
											<li title="">产品类型:&nbsp;<?php echo $v[8]?></li>
											<li title="">原料产地:&nbsp;<?php echo $v[9]?></li>
											<li title="">产地:&nbsp;<?php echo $v[10]?></li>
											<li title="">配料表:&nbsp;<?php echo $v[11]?></li>
											<li title="">产品规格:&nbsp;<?php echo $v[12]?></li>
											<li title="">保质期:&nbsp;<?php echo $v[13]?></li>
											<li title="">产品标准号:&nbsp;<?php echo $v[14]?></li>
											<li title="">生产许可证编号：&nbsp;<?php echo $v[15]?></li>
											<li title="">储存方法：&nbsp;<?php echo $v[16]?></li>
											<li title="">食用方法：&nbsp;<?php echo $v[17]?></li>
										</ul>
										<div class="clear"></div>
									</div>
			...
			<script>
				...
				jQuery.ajax({
					...
					url:"../shop/shopCart.php",
					type:"POST",
					data:"a="+a+"&b="+b+"&uid=<?php echo $uid?>&lid=<?php echo $lid?>&sum="+$("#text_box").val()+"",
